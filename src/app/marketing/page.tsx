      ...
      <header className="relative z-20 border-b border-[#dfe5dc] bg-[#f7f7f3]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 lg:px-8">
          <Link href="/" className="flex items-center gap-3" aria-label="Natural Intellects home">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Natural%20Intellects%20LTD%20LOGO-kW8y0UnJCLLYKZinLc70NoJI9YPSup.png" alt="Natural Intellects Ltd" className="h-12 w-12 rounded-full object-cover" />
            <span className="sr-only">Natural Intellects Ltd</span>
          </Link>
          ...
          <div className="hidden items-center gap-3 lg:flex"><Link href="/login" className="rounded-full px-4 py-2.5 text-sm font-medium text-[#173b2b] hover:bg-[#e8eee5]">Log in</Link><Link href="/start-free-trial" className="rounded-full bg-[#173b2b] px-5 py-2.5 text-sm font-semibold text-[#f7f7f3] shadow-sm transition-transform hover:-translate-y-0.5">Start free trial <ArrowRight className="ml-1 inline h-4 w-4" /></Link></div>
        ...
        {menuOpen && <nav className="flex flex-col gap-4 border-t border-[#dfe5dc] px-5 py-5 text-sm lg:hidden" aria-label="Mobile navigation"><a href="#features" className="rounded-md py-2 focus:outline-none focus:ring-2 focus:ring-[#b2761b]" onClick={() => setMenuOpen(false)}>Features</a><a href="#how-it-works" className="rounded-md py-2 focus:outline-none focus:ring-2 focus:ring-[#b2761b]" onClick={() => setMenuOpen(false)}>How it works</a><a href="#pricing" className="rounded-md py-2 focus:outline-none focus:ring-2 focus:ring-[#b2761b]" onClick={() => setMenuOpen(false)}>Pricing</a><Link href="/login" className="rounded-md py-2 focus:outline-none focus:ring-2 focus:ring-[#b2761b]">Log in</Link><Link href="/start-free-trial" className="rounded-md py-2 font-semibold text-[#173b2b] focus:outline-none focus:ring-2 focus:ring-[#b2761b]">Start free trial <ArrowRight className="ml-1 inline h-4 w-4" /></Link></nav>}
      </header>
